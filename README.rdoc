...
FuseJS can emulate other frameworks* by creating a shell of the target framework
...
better than their official counterpart. In most cases a developer can simply replace a
...
FuseJS is also the first JavaScript framework to use cross-browser/platform sandboxed 
...
ECMA 2.62 and 5 draft specifications. Developers can create customized builds 
of FuseJS and choose one of seven supported CSS selector engines. FuseJS has in-line
documentation, supports minification, and is released under the MIT license.

* Prototype is currently the only emulated framework.
  jQuery support will be added A.S.A.P.
