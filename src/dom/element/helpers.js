  ...
  (function() {
    Object._extend(Element, {
      '_returnOffset': function _returnOffset(left, top) {
        var result  = [left, top];
        result.left = left;
        result.top  = top;
        return result;
      ...
      '_getCssDimensions': function _getCssDimensions(element) {
        return { 'width': Element._getCssWidth(element), 'height': Element._getCssHeight(element) };
      },
  
      '_getRealOffsetParent': function _getRealOffsetParent(element) {
     ...
     '_getContentFromAnonymousElement': (function() {
