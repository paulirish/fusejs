  ...
  (function() {
    Object._extend(this, {
      'adjacent': function adjacent(element) {
        element = $(element);
      ...
      'immediateDescendants': function immediateDescendants(element) {
      ...
      'nextSiblings': function nextSiblings(element) {
        return Element.recursivelyCollect(element, 'nextSibling');
      },

      'previousSiblings': function previousSiblings(element) {
        return Element.recursivelyCollect(element, 'previousSibling');
      },

      'recursivelyCollect': function recursivelyCollect(element, property) {
        element = $(element);
        var elements = [];
  ...
  (function() {
    ...
    Object._extend(Element.Methods, {
      'next': function next(element, expression, index) {
        if (arguments.length === 1)
      ...
      'previous': function previous(element, expression, index) {
        if (arguments.length == 1)
      ...
      'up': function up(element, expression, index) {
        if (arguments.length === 1)
